import { getCurrentInstance as getCurrentInstance$1, inject as inject$1, defineAsyncComponent, version as version$1, defineComponent as defineComponent$1, h, onUnmounted, createVNode, mergeProps, toRefs, ref, computed, watch, nextTick, toRef, Text, watchEffect, provide, onScopeDispose, withDirectives, vShow, resolveDirective, reactive, capitalize, unref, Suspense, Transition, resolveComponent, shallowRef, Fragment as Fragment$1, camelize, isRef, readonly, TransitionGroup, resolveDynamicComponent, cloneVNode, effectScope, warn as warn$1, toHandlers, Teleport, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, withCtx } from 'vue';
...
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, useRouter as useRouter$2 } from 'vue-router';
...
import { faEye, faBagShopping, faXmark, faPlus, faMinus, faBars } from '@fortawesome/free-solid-svg-icons';
...
defuFn(inlineConfig);
const components$1 = {
  Modal: defineAsyncComponent(() => import(
    /* webpackChunkName: "components/modal" */
    './Modal.aac52a0f.mjs'
  ).then((c) => c.default || c)),
  SmallCircleButton: defineAsyncComponent(() => import(
    /* webpackChunkName: "components/small-circle-button" */
    './SmallCircleButton.9b85c2c4.mjs'
  ).then((c) => c.default || c))
};
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "hid": "og:site_name", "property": "og:site_name", "content": "StreetBarbell" }, { "hid": "og:type", "property": "og:type", "content": "website" }], "link": [{ "rel": "icon", "type": "image/png", "href": "/img/icon/StreetBarbellLogo.svg" }, { "rel": "apple-touch-icon", "type": "image/png", "href": "/img/icon/StreetBarbellLogo.png" }, { "rel": "manifest", "href": "/manifest.json" }, { "rel": "robots", "href": "/robots.txt" }], "style": [], "script": [], "noscript": [{ "innerHTML": "This website requires javascript to run. Please enable it in browser settings." }], "htmlAttrs": { "lang": "en", "dir": "ltr" }, "title": "StreetBarbell" };
...
const _routes = [
  {
    name: (_a = __nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) != null ? _a : "about",
    path: (_b = __nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) != null ? _b : "/about",
    file: "Z:/streetbarbell/src/pages/about.vue",
    children: [],
    meta: __nuxt_page_meta$3,
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./about.2a8824c1.mjs').then((m) => m.default || m)
  },
  {
    name: (_c = __nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) != null ? _c : "index",
    path: (_d = __nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) != null ? _d : "/",
    file: "Z:/streetbarbell/src/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta$2,
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./index.17e9f1ba.mjs').then((m) => m.default || m)
  },
  {
    name: (_e = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) != null ? _e : "items-id",
    path: (_f = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) != null ? _f : "/items/:id",
    file: "Z:/streetbarbell/src/pages/items/[id].vue",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_id_.91c49548.mjs').then((m) => m.default || m)
  },
  {
    name: (_g = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) != null ? _g : "shop",
    path: (_h = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) != null ? _h : "/shop",
    file: "Z:/streetbarbell/src/pages/shop.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./shop.9e55db0f.mjs').then((m) => m.default || m)
  }
];
...
const localeCodes = ["en", "fi", "ru"];
const localeMessages = {};
const additionalMessages = Object({ "en": [], "fi": [], "ru": [] });
const resolveNuxtI18nOptions = async (context) => {
  const nuxtI18nOptions = Object({});
  const vueI18nOptionsLoader = async (context2) => Object({ "silentFallbackWarn": true, "fallbackLocale": "en", "messages": Object({ "en": {
    "text": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Hello, English!"]);
    }
  }, "fi": {
    "text": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Hello, Finnish!"]);
    }
  }, "ru": {
    "text": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Hello, Russian!"]);
    }
  } }) });
  nuxtI18nOptions.vueI18n = await vueI18nOptionsLoader();
  nuxtI18nOptions.locales = [Object({ "code": "en", "iso": "en-UK", "long": "English" }), Object({ "code": "fi", "iso": "fi", "long": "Finnish" }), Object({ "code": "ru", "iso": "ru", "long": "Russian" })];
  ...
  nuxtI18nOptions.detectBrowserLanguage = Object({ "alwaysRedirect": false, "cookieCrossOrigin": false, "cookieDomain": null, "cookieKey": "i18n", "cookieSecure": false, "fallbackLocale": "en", "redirectOn": "root", "useCookie": true, "onlyOnRoot": true });
...
const nuxtI18nInternalOptions = Object({ __normalizedLocales: [Object({ "code": "en", "iso": "en-UK", "long": "English" }), Object({ "code": "fi", "iso": "fi", "long": "Finnish" }), Object({ "code": "ru", "iso": "ru", "long": "Russian" })] });
...
library.add(faEye, faBagShopping, faXmark, faPlus, faMinus, faFacebookF, faInstagram, faLinkedinIn, faBars);
  ...
  if (options._setup) {
    ...
    options.setup = function setup(props, ctx) {
      ...
      const componentDefaults = computed(() => {
        var _a3;
        return defaults.value[(_a3 = props._as) != null ? _a3 : options.name];
      });
      const _props = new Proxy(props, {
        get(target, prop) {
          ...
          if (!propIsDefined(vm.vnode, prop)) {
            ...
            return (_b3 = (_a3 = (_componentDefaults$va = componentDefaults.value) == null ? void 0 : _componentDefaults$va[prop]) != null ? _a3 : (_global = defaults.value.global) == null ? void 0 : _global[prop]) != null ? _b3 : target[prop];
          }
  ...
  hide(el) {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        if (((_animation$parentNode = animation.parentNode) == null ? void 0 : _animation$parentNode.parentNode) === el)
...
const VInput = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      const hasMessages = !!((_props$messages = props.messages) != null && _props$messages.length || errorMessages2.value.length);
...
const src_plugins_vuetify_js_QwmrB3LYDa = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  src_plugins_vuetify_js_QwmrB3LYDa
];
...
const layouts = {
  default: () => import('./default.9620f5d3.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.09a9d411.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useDisplay as a, __nuxt_component_0$1 as b, createError as c, useRoute as d, entry$1 as default, useNuxtApp as u };
